...
def chevron_item(label: str, href: str = "#") -> rx.Component:
...
def footer() -> rx.Component:
    ...
    """
    return rx.box(
        # Upper Helpline & Complaint Action Ribbon (White background with blue accent)
        rx.box(
            rx.box(
                rx.vstack(
                    rx.text(
            ...
            rx.box(
                rx.grid(
                    ...
                    rx.vstack(
                        ...
                        chevron_item("Disclaimer", href="/docs"),
                        spacing="2",
                        align="start",
                    ),
